package examples.planned.dialogstatefull; 
...
*/
	...
	public void init() {
		...
		try {
			...
			// Associate a dialog with the outgoing transaction. This has to be done manually.
			Dialog dialog = ((SipProviderImpl) sipProvider).createDialog(listener.inviteTid);
