...
public class DefaultSecurityManagerProvider implements SecurityManagerProvider {
    ...
    public void init(Properties properties)
        ...
        if (keyStoreFilename == null || keyStorePassword == null) {
            logger.logWarning("TLS server settings will be inactive - TLS key store can not be configured."
        ...
        if (trustStoreFilename == null || trustStorePassword == null) {
            logger.logWarning("TLS trust settings will be inactive - TLS trust store can not be configured."
