...
public class MediaDescriptionImpl 
	...
	*/
    ...
    throws SdpException {
        ...
        else throw new SdpException("A mediaField parameter is required");
    }
    ...
    public Info getInfo() {
        ...
        if (informationField==null) return null;
        else {
            return informationField;
        }
    }
    ...
    throws SdpException {
        ...
        else throw new SdpException("A informationField parameter is required");
    }
    ...
    throws SdpException {
        ...
        else throw new SdpException("bad implementation");
    }
    ...
    throws SdpParseException {
       ...
       if (bandwidthFields ==null) return -1;
       else {
		for (int i = 0; i < bandwidthFields.size(); i++) {
    ...
    throws SdpException {
        ...
        else throw new SdpException("A keyField parameter is required");
    }
    ...
    String value)
    throws SdpException {
        if (name==null ) throw new SdpException
    ...
    throws SdpException {
        ...
        for (int i=0;i<formats.size();i++) {
            ...
            if (protocol.equals("RTP/AVP") ) {
                if (getAttribute(SdpConstants.RTPMAP) !=null ) result=type+"/"+protocol;
                else {
                  
                }
            }
            else result=type+"/"+protocol;
            v.addElement(result);
        }
        return v;
    }
 ...
 */
    ...
    throws SdpException {
        MediaField mediaField=(MediaField)getMedia();
        if (payloadNames==null || payloadValues==null) throw new 
        SdpException(" The vectors are null");
        else {
            if (payloadNames.isEmpty() || payloadValues.isEmpty() ) throw new
            SdpException(" The vectors are empty");
            else {
                if (payloadNames.size() != payloadValues.size() ) throw new 
                    SdpException(" The vector sizes are unequal");
                else {
