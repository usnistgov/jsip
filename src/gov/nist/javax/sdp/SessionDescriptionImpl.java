...
public class SessionDescriptionImpl implements SessionDescription {
    ...
    public void addField(SDPField sdpField) throws ParseException {
        try {
            if (sdpField instanceof ProtoVersionField)  {
                ...
                else bandwidthList.add(sdpField);
    ...
    throws SdpException {
        ...
        new SdpException("The parameter must be an instance of OriginField");
    }
    ...
    throws SdpException {
        ...
        SdpException("The parameter must be an instance of SessionNameField");
    }
    ...
    throws SdpException{
        ...
        else throw new SdpException("The parameter must be an instance of InformationField");
    }
    ...
    throws SdpException{
        ...
        else throw new SdpException("The parameter must be an instance of URIField");
    }
    ...
    throws SdpException {
        if (emails==null) throw new SdpException("The parameter is null");
    ...
    throws SdpException{
        if (phones==null) throw new SdpException("The parameter is null");
        else phoneList=phones;
    }
    ...
    throws SdpException{
        if (times==null) throw new SdpException("The parameter is null");
        else {
    ...
    throws SdpException {
        if (bandwidthList==null) throw new SdpException("The parameter is null");
        else bandwidthList=bandwidthList;
    }
    ...
    int value)
    throws SdpException {
        if (name==null ) throw new SdpException("The parameter is null");
        else
            if (bandwidthList!=null) {
                for (int i=0;i<bandwidthList.size();i++) {
                    Object o=bandwidthList.elementAt(i);
    ...
    throws SdpException {
        if (attributes==null) throw new SdpException("The parameter is null");
