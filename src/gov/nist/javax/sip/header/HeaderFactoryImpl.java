...
public class HeaderFactoryImpl implements HeaderFactory {
    ...
    throws ParseException {
		...
		("the encoding parameter is null");
   ...
   /**
    ...
    public AcceptHeader createAcceptHeader(String contentType, String contentSubType)
        ...
        if ( contentType==null || contentSubType == null)
            throw new NullPointerException 
                            ("contentType or subtype is null ");
   ...
   /**
     ...
     *
     * @param alertInfo - the new string value of the callInfo.
	...
	(String name, String value) throws ParseException {
	  if (name == null ) 
		throw new NullPointerException("bad name");
          ...
          gov.nist.javax.sip.header.ExtensionHeaderImpl ext=new 
     ...
     *
     * @param mimeVersion - the new integer value of the mimeVersion.
    ...
    public MimeVersionHeader createMimeVersionHeader
	 ...
	 if (majorVersion < 0 || minorVersion< 0)
		throw new 
                javax.sip.InvalidArgumentException("bad major/minor version");
	...
	if (cause < 0) throw new InvalidArgumentException("bad cause");
   ...
   /**
    ...
    public UnsupportedHeader createUnsupportedHeader(String optionTag)
                              throws ParseException {
	 if (optionTag == null) throw new NullPointerException(optionTag);
	...
	createWarningHeader(String agent, int code, String comment)
        throws  ParseException, InvalidArgumentException  {
	if (agent == null ) throw new NullPointerException("null arg");
	...
	if (errorInfo == null) throw new NullPointerException("null arg");
       ...
       */
    public javax.sip.header.Header 
	    ...
	    if (sipHeader instanceof SIPHeaderList  )  {
		  if ( ((SIPHeaderList) sipHeader).size() > 1)  {
			...
			("Only singleton allowed " + hdrText,0);
