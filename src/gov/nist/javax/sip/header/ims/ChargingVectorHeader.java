 ...
 * 										xdsl-charging-info / generic-param)
 ...
 * 	flow-id 					= "flow-id" EQUAL "(" "{" 1*DIGIT COMMA 1*DIGIT "}" 
 *									*(COMMA "{" 1*DIGIT COMMA 1*DIGIT"}")")"
 ...
 *	xDSL-bearer-info 			= "dsl-bearer-info" EQUAL LDQUOT dsl-bearer-info 
 *									*(COMMA dsl-bearer-info) RDQUOT
...
public interface ChargingVectorHeader extends Header, Parameters {
