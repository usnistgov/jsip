...
implements javax.sip.message.Message {
    ...
    public Via getTopmostVia() {
        if (this.getViaHeaders() == null) return null;
        else return (Via) (getViaHeaders().getFirst());
    }
    ...
    private LinkedList getHeaderList(String headerName) {
        SIPHeader sipHeader= (SIPHeader) nameTable.get(headerName.toLowerCase());
        if (sipHeader == null) return null;
        else if (sipHeader instanceof SIPHeaderList)
            return (LinkedList)
            (((SIPHeaderList) sipHeader).getHeaderList());
        else {
   ...
   public boolean equals(Object other) {
    ...
    public javax.sip.header.ContentEncodingHeader getContentEncoding() {
        ...
        this.getHeader(ContentEncodingHeader.NAME);
    }
