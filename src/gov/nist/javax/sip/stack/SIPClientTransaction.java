...
PendingRecord{
    ...
    public boolean isMessagePartOfTransaction(SIPMessage messageToTest) {
         ...
         * sipStack.logWriter.logMessage(" testing " + this.getOriginalRequest());
         * sipStack.logWriter.logMessage("Against " + messageToTest);
         * sipStack.logWriter.logMessage("isTerminated = " + isTerminated());
         * sipStack.logWriter.logMessage("messageBranch = " + messageBranch);
         * sipStack.logWriter.logMessage("viaList = " + messageToTest.getViaHeaders());
