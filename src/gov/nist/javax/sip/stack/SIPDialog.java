 ...
 *
 *@version  JAIN-SIP-1.1 $Revision: 1.5 $ $Date: 2004-10-04 16:03:53 $
 *
 ...
 public void putPending(NistSipMessageHandlerImpl pendingRecord, int seqno) {
   ...
   public boolean isTerminated() {
    ...
    public HopImpl getNextHop() throws SipException {
        ...
        String host = sipUri.getMAddrParam() != null? 
		sipUri.getMAddrParam(): sipUri.getHost();
    ...
    public void printDebugInfo() {
        if (LogWriter.needsLogging) {
            ...
            sipStack.logWriter.logMessage("localSequenceNumer = " + getLocalSequenceNumber());
            sipStack.logWriter.logMessage("remoteSequenceNumer = " + getRemoteSequenceNumber());
            sipStack.logWriter.logMessage("ackLine:" +
			this.getRemoteTag() + " " + ackLine);
        }
    }
    ...
    private void addRoute(RecordRouteList recordRouteList) {
        if (this.isClientDialog()) {
            ...
            ListIterator li =
            recordRouteList.listIterator(recordRouteList.size());
            while (li.hasPrevious()) {
    ...
    public String getDialogId() {
        ...
        if (firstTransaction instanceof SIPServerTransaction) {
            ...
            != null) {
                this.dialogId =
                ((SIPClientTransaction) firstTransaction)
                .getLastResponse()
                .getDialogId(
                false,
                this.hisTag);
    ...
    public void sendAck(Request request) throws SipException {
        ...
        .getCallId()
        .getCallId()
        .equals(((SIPRequest) request).getCallId().getCallId())) {
    ...
    public Request createRequest(String method) throws SipException {
        ...
        && method.equalsIgnoreCase(Request.BYE)))
            ...
            "Dialog  "
            + getDialogId()
            + " not yet established or terminated "
            + this.getState());
        ...
        try {
            ...
            if (!method.equals(Request.ACK)) {
                ...
                (SIPResponse) this.lastTransaction.getLastResponse();
                if (response == null)
    ...
    throws TransactionDoesNotExistException, SipException {
        ...
        ((SIPClientTransaction) clientTransactionId).getOriginalRequest();
        ...
        || dialogRequest.getMethod().equals(Request.CANCEL))
            throw new SipException(
            "Bad Request Method. " + dialogRequest.getMethod());
	...
	**/
        ...
        .getCallId()
        .getCallId()
        .equals(dialogRequest.getCallId().getCallId())) {
            throw new SipException("Bad call ID in request");
        }
 ...
 * Revision 1.4  2004/09/01 02:04:14  xoba
