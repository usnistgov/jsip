 ...
 *</pre>
 *
 * @version  JAIN-SIP-1.1 $Revision: 1.15 $ $Date: 2004-01-22 13:26:33 $
 * @author Jeff Keyser 
...
public class SIPServerTransaction
	...
	class SendTrying extends TimerTask {
		...
		public void run() {
			if (this.serverTransaction.getState() == null
				|| TransactionState.TRYING == this.serverTransaction.getState()) {
				if (LogWriter.needsLogging)
	 ...
	 */
	protected void map() {
		if (getState() == null || getState() == TransactionState.TRYING) {
