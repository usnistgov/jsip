    ...
    extends MessageFlowHarness
{
    ...
    public void testTryingProceedingCompletedScenario()
    {
        try
        {
            ...
            waitForMessage();
            RequestEvent registerReceivedEvent = eventCollector.
                                                 extractCollectedRequestEvent();
            if(registerReceivedEvent==null
               ||registerReceivedEvent.getRequest()==null)
                throw new TiUnexpectedError(
                    "The initial register request was not received by the TI!");
            //Let's create the transaction
            ServerTransaction tran = null;
            try
            {
                tran = tiSipProvider.
                       getNewServerTransaction(registerReceivedEvent.getRequest());
            }
            catch(Exception ex)
            {
                ex.printStackTrace();
            ...
            try
            {
                trying = tiMessageFactory.createResponse(
                    Response.TRYING, registerReceivedEvent.getRequest());
            ...
            assertNotNull(
                ...
                responseEvent);
            assertTrue("A response different from 100 was sent by the TI",
                       Response.TRYING
            ...
            waitForMessage();
            registerReceivedEvent = eventCollector.
                                    extractCollectedRequestEvent();
            assertNull(
    ...
    public static void main(String[] args)
    {
        junit.swingui.TestRunner.run(
            NonInviteServerTransactionsStateMachineTest.class);
    }
