...
public class SessionDescriptionImpl implements SessionDescription
{
  ...
  public Object clone() throws CloneNotSupportedException
  {
    ...
    hi.timeDescriptions = this.timeDescriptions == null ? null : (Vector) this.timeDescriptions.clone();
    hi.emailList = this.emailList == null ? null : (Vector) this.emailList.clone();
    hi.phoneList = this.phoneList == null ? null : (Vector) this.phoneList.clone();
    hi.zoneAdjustments = this.zoneAdjustments == null ? null : (Vector) this.zoneAdjustments.clone();
    hi.bandwidthList = this.bandwidthList == null ? null : (Vector) this.bandwidthList.clone();
    hi.attributesList = this.attributesList == null ? null : (Vector) this.attributesList.clone();
    hi.mediaDescriptions = this.mediaDescriptions == null ? null : (Vector) this.mediaDescriptions.clone();
    return hi;
  }
...
/*
 * $Log:
 *  3    VoiceAnyware1.2         2/12/2004 9:16:52 AM   Whitaker, Chris Updated
 *       NIST stack
 *  2    VoiceAnyware1.1         11/10/2003 1:18:58 PM  Whitaker, Chris
 *       Reformatting
 *  1    VoiceAnyware1.0         10/1/2003 10:46:37 AM  Whitaker, Chris 
 * $
