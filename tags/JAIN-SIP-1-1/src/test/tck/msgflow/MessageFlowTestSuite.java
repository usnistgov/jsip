...
public class MessageFlowTestSuite extends TestSuite {
	...
	public MessageFlowTestSuite(String name) {
		...
		addTestSuite(
			test.tck.msgflow.InviteClientTransactionsStateMachineTest.class);
		addTestSuite(
			test.tck.msgflow.NonInviteClientTransactionsStateMachineTest.class);
		addTestSuite(
			test.tck.msgflow.InviteServerTransactionsStateMachineTest.class);
		addTestSuite(
			test.tck.msgflow.NonInviteServerTransactionsStateMachineTest.class);
