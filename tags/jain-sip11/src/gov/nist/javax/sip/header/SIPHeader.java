...
*/
public abstract class SIPHeader extends SIPObject 
implements SIPHeaderNames, javax.sip.header.Header {
	...
	*@return false
	*/
	public boolean isHeaderList() { return false; }

	/** Encode this header into canonical form.
	*/
	public  String encode() {
		return this.headerName + COLON + 
			SP + this.encodeBody() + NEWLINE;
	}
	...
	*/
	protected abstract String encodeBody();
         ...
         */
        public String getValue() { return this.getHeaderValue(); }
