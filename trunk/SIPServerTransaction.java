 ...
 * </pre>
 * 
 * @version 1.2 $Revision: 1.1 $ $Date: 2007-01-12 19:49:10 $
		...
		try {
			...
			if (getRealState() == null) {
				...
				if (isInviteTransaction() && this.isMapped) { // JvB: also
					...
					// state to "Proceeding"
/*
 * [rborba] Don't send the 100 Trying immediately after receiveing an INVITE (instead, wait for 200 ms timer).
 *
