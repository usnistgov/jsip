    ...
    public void processInvite(RequestEvent requestEvent,
        ...
        try {
            ...
            if (st == null) {
                ...
                Dialog dialog = ((SipProviderImpl) sipProvider).createDialog(st);
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.20 2004/09/26 14:48:01 mranga Submitted by:
 * John Martin Reviewed by: mranga
 * 
 * Remove unnecssary synchronization.
 * 
 * Revision 1.19 2004/06/16 02:53:17 mranga Submitted by: mranga Reviewed by:
 * implement re-entrant multithreaded listener model.
 * 
 * Revision 1.18 2004/06/15 09:54:39 mranga Reviewed by: mranga re-entrant
 * listener model added. (see configuration property
 * gov.nist.javax.sip.REENTRANT_LISTENER)
 * 
 * Revision 1.17 2004/05/16 14:13:20 mranga Reviewed by: mranga Fixed the
 * use-count issue reported by Peter Parnes. Added property to prevent against
 * content-length dos attacks.
 * 
 * Revision 1.16 2004/04/07 13:46:30 mranga Reviewed by: mranga move processing
 * of delayed responses outside the synchronized block.
 * 
 * Revision 1.15 2004/04/07 00:19:22 mranga Reviewed by: mranga Fixes a
 * potential race condition for client transactions. Handle re-invites
 * statefully within an established dialog.
 * 
 * Revision 1.14 2004/03/30 18:10:53 mranga Reviewed by: mranga added code to
 * demonstrate cleanup
 * 
 * Revision 1.13 2004/03/12 21:53:08 mranga Reviewed by: mranga moved some
 * comments around for ifdef support.
 * 
 * Revision 1.12 2004/03/07 22:25:22 mranga Reviewed by: mranga Added a new
 ...
 * is true.
 * 
 * Revision 1.11 2004/03/05 20:36:54 mranga Reviewed by: mranga put in some
 * debug printfs and cleaned some things up.
 * 
 * Revision 1.10 2004/02/26 14:28:50 mranga Reviewed by: mranga Moved some code
 ...
 * 
 * Revision 1.9 2004/02/13 13:55:31 mranga Reviewed by: mranga per the spec,
 ...
 * 
 * Revision 1.8 2004/01/22 13:26:27 sverker Issue number: Obtained from:
