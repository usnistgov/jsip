...
implements javax.sip.address.SipURI{
    ...
    */
    ...
    public String encode() {
          StringBuffer retval = 
		new StringBuffer(scheme).append(COLON);
	  if (authority != null) 
	...
	*/
    ...
    public void setUserPassword(String password) {
        if (this.authority == null) this.authority = new Authority();
	...
	*/
	...
	this.setHost(h);
     ...
     public void setLrParam()  {
	  if (this.uriParms.getValue("lr") != null) return;
	...
	if (maddr == null) throw new NullPointerException("bad maddr");
	...
	if (transport == null) throw new NullPointerException("null arg");
