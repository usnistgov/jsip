...
implements  java.util.List {
    ...
    protected static final String SIPHEADERS_PACKAGE = PackageNames.SIPHEADERS_PACKAGE;
    ...
    public String encode() {
        if (hlist.isEmpty()) return headerName + ":" + NEWLINE;
	...
	if (hlist == null || hlist.isEmpty()) return null;
        else return (SIPHeader) hlist.getFirst();
    }
	...
	if (hlist.size() != 0) hlist.removeFirst();
    ...
    public void removeLast() {
        if (hlist.size() != 0) hlist.removeLast();
    }
    ...
    public Object clone() {
	    ...
	    retval.headerName = this.headerName;
            for(SIPHeader v = (SIPHeader) this.first(); v != null;
     ...
     *@return true
     */
    public boolean isHeaderList() { return true; }
    ...
    public int lastIndexOf(Object obj) {
        ...
        ! obj.getClass().equals(this.getMyClass()) ) return -1;
