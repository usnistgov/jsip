...
public final class SIPRequest extends SIPMessage 
	...
	protected void checkHeaders() throws ParseException {
		...
		if (getMaxForwards() == null) {
			throw new ParseException
				(prefix + MaxForwardsHeader.NAME,0);
		}
		...
		*/
		...
		if ( requestLine != null && requestLine.getMethod() != null &&
			...
			requestLine.getMethod().compareToIgnoreCase
			(getCSeq().getMethod()) != 0 ) {
			throw
		            new ParseException
	...
	*/
	public javax.sip.address.URI getRequestURI() {
		...
		else return (javax.sip.address.URI) 
			this.requestLine.getUri();
	}
	...
	*/
	public void setMethod(String method) {
		...
		if (this.cSeqHeader != null) {
		    try{this.cSeqHeader.setMethod(method);}catch(ParseException e){}
		}
	}
